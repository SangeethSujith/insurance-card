...
const Card = ({heading,desc}) => {
    return (
        <div
            className="w-[90%] h-auto duration-500 group overflow-hidden relative rounded-xl bg-neutral-800 text-neutral-50 p-4 flex flex-col justify-evenly"
        >
            <div
            ...
            <div className="z-10 flex flex-col justify-evenly w-full h-full">
                ...
                <button
                    className="hover:bg-neutral-200 bg-neutral-50 rounded text-neutral-800 self-center font-extrabold w-full md:w-[50%] p-3"
                >
                    Know more
                </button>
            </div>
